  ...
  return (
    <GameLayout>
      <div className='flex flex-col items-center justify-center text-white gap-y-10'>
        <h2 className=' text-[56px]'>Streaming by BlokTV</h2>
        ...
        <div className='flex flex-row items-center justify-center text-white gap-x-10'>
          <div className='relative flex items-center justify-center'>
            ...
            ></div>
            <span className='absolute top-[60px] text-[80px]'>Kodi</span>
          </div>
          ...
          <div className='relative flex items-center justify-center'>
            ...
            ></div>
            <span className='absolute top-[60px] text-[70px]'>Jellyfin </span>
          </div>
        </div>
      </div>
    </GameLayout>
